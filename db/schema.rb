...
ActiveRecord::Schema.define(version: 2020_10_16_173534) do
  ...
  create_table "group_gear_items", force: :cascade do |t|
    t.integer "user_hike_id"
    t.string "name"
    t.integer "qty"
    t.string "notes"
  ...
  create_table "personal_gear_items", force: :cascade do |t|
    t.integer "user_id"
    t.string "name"
    t.integer "qty"
    t.string "notes"
